...
public class UserController {
    ...
    public SingleResult<User> findUserById(
            @ApiParam(value = "회원ID", required = true, example = "1") @PathVariable long userId) {
    ...
    public User save(
            @ApiParam(value = "회원아이디", required = true, example = "1") @RequestParam String userId,
    ...
    public SingleResult<User> update(
            @ApiParam(value = "회원번호", required = true, example = "1") @RequestParam long msrl,
            @ApiParam(value = "회원아이디", required = true, example = "1") @RequestParam String userId,
            @ApiParam(value = "회원이름", required = true, example = "이름") @RequestParam String name) {
    ...
    public CommonResult delete(
            @ApiParam(value = "회원번호", required = true, example = "1") @PathVariable long userId) {
